    ...
    extend: {
      colors: {
        ...
        destructive: {
          ...
          "subtle-foreground":
            "hsl(var(--destructive-subtle-foreground) / <alpha-value>)",
        },
        warning: {
          ...
          "subtle-foreground":
            "hsl(var(--warning-subtle-foreground) / <alpha-value>)",
        },
        success: {
          ...
          "subtle-foreground":
            "hsl(var(--success-subtle-foreground) / <alpha-value>)",
        },
        info: {
          ...
          "subtle-foreground":
            "hsl(var(--info-subtle-foreground) / <alpha-value>)",
        },
        brand: {
          DEFAULT: "hsl(var(--primary) / <alpha-value>)",
          foreground: "hsl(var(--primary-foreground) / <alpha-value>)",
